...
public class TestEmpProject{
    ...
    @Test
    public void testQueryEmpWithDname() throws Exception{
        String config = "mybatis-config.xml";
        Reader resource = Resources.getResourceAsReader(config);
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resource);
        ...
        List<Employee> employees = employeeMapper.queryEmpWithDname("销售部");
        System.out.println(employees);
        sqlSession.close();
    }

    @Test
    public void testQueryEmpWithJob() throws Exception{
        String config = "mybatis-config.xml";
        Reader resource = Resources.getResourceAsReader(config);
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resource);
        ...
        List<Employee> employees = employeeMapper.queryEmpWithJob("庞统");
